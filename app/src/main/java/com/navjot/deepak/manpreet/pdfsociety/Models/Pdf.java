...
public class Pdf {
    ...
    public Pdf(String pdfname, String description, String uid, int no_of_downloads, String download_url, String username, double pdfsize, String uploaddate, String pdfKey) {
